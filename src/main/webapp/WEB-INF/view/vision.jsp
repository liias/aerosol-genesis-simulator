...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/jquery_ui/css/ui-lightness/jquery-ui-1.8.23.custom.css" />"/>
	<script type="text/javascript" src="<c:url value="/resources/jquery_ui/js/jquery-1.8.0.min.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/jquery_ui/js/jquery-ui-1.8.23.custom.min.js" />"></script>
